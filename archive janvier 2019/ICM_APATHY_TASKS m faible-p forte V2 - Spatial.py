...
class hetero(tkinter.Tk):
        def __init__(self,parent):
                ...
                self.RTFacile=(self.RTSFFa+self.RTSFFo)/2
        ...
        def lancementmetronome(self):
                if self.metro==0:
                        self.racine0.after(self.RTFacile, self.metronome)
                
        def metronome(self):
                if self.troplent%3!=0 and self.tempssecondeslimite!=810:
        ...
        def seclimite(self):
                ...
                if self.tempssecondeslimite==self.RTFacile+50:
                        self.tempssecondeslimite=0
                        self.startlimite2()
                else:
                        self.startlimite1()
