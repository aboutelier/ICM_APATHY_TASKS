...
class SDf(tkinter.Tk):
	...
	def time(self):                
		...
		self.fond0 = tkinter.Canvas(self.racine0, bg='white', width=self.w, height=self.h)
		self.fond0.pack(fill='both')
		end=self.fond0.create_text(self.w/2,self.h/2,text='THE END\nCliquez 3 fois avec la souris pour continuer...', font='Arial 30', justify='center')
...
class SDF(tkinter.Tk):
	def __init__(self,parent):
		...
		f = open("C:\\Users\johan.ferrandverdejo\Desktop\Sujet_SpatialeDifficileFort.xls", "a")
	...
	def time(self):                
		...
		print('Taux de réussite= %.2f'%self.taux)
		f.write('Taux de réussite=[ %.2f\n'%self.taux)
		gain=self.fond0.create_text(self.w/3,self.h/4,text='Vous avez gagné BEAUCOUP.', font='Arial 50', justify='center')
		print('RTmoy sec= %.3f'%self.RTmoy)
		f.write('RTmoy sec=[ %.3f\n'%self.RTmoy)
		print('RTmax sec= %.3f'%self.RTmax)
		f.write('RTmax sec=[ %.3f\n'%self.RTmax)
...
class SFf(tkinter.Tk):
        def __init__(self,parent):
                ...
                f = open("C:\\Users\johan.ferrandverdejo\Desktop\Sujet_SpatialeFacileFaible.xls", "a")
...
class VDf(tkinter.Tk):
	def __init__(self,parent):
		...
		f = open("C:\\Users\johan.ferrandverdejo\Desktop\Sujet_VerbaleDifficileFaible.xls", "a")
...
class VFf(tkinter.Tk):
        def __init__(self,parent):
                ...
                f = open("C:\\Users\johan.ferrandverdejo\Desktop\Sujet_VerbaleFacileFaible.xls", "a")
        ...
        def hasard(self):
                ...
                self.consonne1=["X", "T", "M", "S", "F", "G", "H", "C", "Z", "x", "t", "m", "s", "f", "g", "h", "c", "z"]
                self.consonne2=["M", "H", "T", "P", "S", "F", "G", "H", "C", "Z", "m", "x", "t", "p", "s", "f", "g", "h", "c", "z"]
...
class VFF(tkinter.Tk):
        ...
        def hasard(self):
                ...
                self.voyelle=["A", "E", "I", "O", "U", "a", "e", "i", "o", "u"]
                self.consonne1=["X", "T", "P", "S", "F", "G", "H", "C", "Z", "x", "t", "p", "s", "f", "g", "h", "c", "z"]
                self.consonne2=["M", "X", "T", "P", "S", "F", "G", "H", "C", "Z", "m", "x", "t", "p", "s", "f", "g", "h", "c", "z"]
                self.motcible=random.choice(self.lettre1cible)+random.choice(self.voyelle)+random.choice(self.consonne2)+random.choice(self.voyelle)
                self.motdistracteur=random.choice(self.consonne1)+random.choice(self.voyelle)+random.choice(self.consonne2)+random.choice(self.voyelle)
...
ordretaches=[0]
while ordre!=[]:
        f = open("C:\\Users\johan.ferrandverdejo\Desktop\Sujet_ordre.xls", "a")
        tirage=random.choice(ordre)
        #print('Tirage {}'.format(tirage))
        if len(ordre)==3 and (1) in ordre and (2) in ordre :
                ordreforce=[1,2]
                tirage=random.choice(ordreforce)
                #print('Tirage forcé')
                #print('{}'.format(tirage))
        if len(ordre)==3 and (3) in ordre and (4) in ordre :
                ordreforce=[3,4]
                tirage=random.choice(ordreforce)
                #print('Tirage forcé')
                #print('{}'.format(tirage))
        if len(ordre)==3 and (5) in ordre and (6) in ordre :
                ordreforce=[5,6]
                tirage=random.choice(ordreforce)
                #print('Tirage forcé')
                #print('{}'.format(tirage))
        if len(ordre)==3 and (7) in ordre and (8) in ordre :
                ordreforce=[7,8]
                tirage=random.choice(ordreforce)
                #print('Tirage forcé')
                #print('{}'.format(tirage))
        if tirage==1 and ordretaches[-1]!=2:
                ordre.remove(tirage)
                ordretaches.append(tirage)
                ordreexercices.append('Spatiale Facile Faible')
                f.write('Spatiale Facile Faible\n')
                ...
                if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        elif tirage==2 and ordretaches[-1]!=1:
                 ordre.remove(tirage)
                 ordretaches.append(tirage)
                 ordreexercices.append('Spatiale Facile Fort')
                 f.write('Spatiale Facile Forte\n')
                 ...
                 if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        elif tirage==3 and ordretaches[-1]!=4:
                 ordre.remove(tirage)
                 ordretaches.append(tirage)
                 ordreexercices.append('Spatiale Difficile Faible')
                 f.write('Spatiale Difficile Faible\n')
                 ...
                 if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        elif tirage==4 and ordretaches[-1]!=3:
                 ordre.remove(tirage)
                 ordretaches.append(tirage)
                 ordreexercices.append('Spatiale Difficile Fort')
                 f.write('Spatiale Difficile Forte\n')
                 ...
                 if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        if tirage==5 and ordretaches[-1]!=6:
                ordre.remove(tirage)
                ordretaches.append(tirage)
                ordreexercices.append('Verbale Facile Faicle')
                f.write('Verbale Facile Faible\n')
                ...
                if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        elif tirage==6 and ordretaches[-1]!=5:
                 ordre.remove(tirage)
                 ordretaches.append(tirage)
                 ordreexercices.append('Verbale Facile Forte')
                 f.write('Verbale Facile Forte\n')
                 ...
                 if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        elif tirage==7 and ordretaches[-1]!=8:
                 ordre.remove(tirage)
                 ordretaches.append(tirage)
                 ordreexercices.append('Verbale Difficile Faible')
                 f.write('Verbale Difficile Faible\n')
                 ...
                 if __name__ == '__main__':
                        ...
                        app.destroy()
                        app.mainloop()
        elif tirage==8 and ordretaches[-1]!=7:
                 ordre.remove(tirage)
                 ordretaches.append(tirage)
                 ordreexercices.append('Verbale Difficile Fort')
                 f.write('Verbale Difficile Forte\n')
