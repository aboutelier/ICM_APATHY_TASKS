...
class hetero(tkinter.Tk):
	...
	def time(self):                
		...
		self.chronosecondes=self.fond0.create_text(self.w/1.7,self.h/8,text="00".format(self.tempssecondes), font=('Arial 120 bold'),fill='black')
		self.chronominutes=self.fond0.create_text(self.w/2.3,self.h/8,text="02:".format(self.tempsminutes), font=('Arial 120 bold'),fill='black')
