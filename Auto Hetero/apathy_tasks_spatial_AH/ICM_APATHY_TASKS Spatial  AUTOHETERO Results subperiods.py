...
class SDf(tkinter.Tk):
    ...
    def acote(self):
        ...
        #RT + temps ecoule
        # print ('[RT = {}\n'.format(self.RT))
        # SRT = self.RT + self.SRT
        #f.write('[{}[{}\n'.format(self.RT,self.SRT))
...
class SFf(tkinter.Tk):
        ...
        def clic(self,event):
                ...
                if self.nbblue[0]<=xclic<=self.nbblue[2] and self.nbblue[1]<=yclic<=self.nbblue[3]:
                    ...
                    # Temps de reponse + temps ecoule
                    f.write('[{}[{}\n'.format(self.RT, self.SRT))

                    # '[{response}[{ecoule}\n'.format(response=self.RT, ecoule=self.SRT)
                    ...
                    #temps ecoule
                    f.write('[{}[{}\n'.format(self.RTerreur, self.SRTerreur))
        ...
        def time(self):
                ...
                f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_RTSpatialeFacileFaible.txt".format(nom,nom), "a")
...
class SFF(tkinter.Tk):
    ...
    def time(self):
        ...
        f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_RTSpatialeFacileForte.txt".format(nom,nom), "a")
        self.RTautohetero=self.RTmoyreussi*1000
        f.write('%d'%self.RTautohetero)
...
class VDf(tkinter.Tk):
    def __init__(self,parent):
        ...
        f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_VerbaleDifficileFaible.xls".format(nom,nom), "a")
...
class VDF(tkinter.Tk):
    def __init__(self,parent):
        ...
        self.pieces2 = PhotoImage(file = 'C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Image\pieces2.ppm')
        self.fond0.create_image(50, 10, image = self.pieces2, anchor = NW)

        f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_VerbaleDifficileFort.xls".format(nom,nom), "a")
...
class VFf(tkinter.Tk):
        def __init__(self,parent):
                ...
                f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_VerbaleFacileFaible.xls".format(nom,nom), "a")
...
class VFF(tkinter.Tk):
        def __init__(self,parent):
                ...
                f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_VerbaleFacileFort.xls".format(nom,nom), "a")
...
class hetero(tkinter.Tk):
        def __init__(self,parent):
                ...
                contenu= open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_RTSpatialeFacileFaible.txt".format(nom,nom), "r")
                self.RTSFFa=contenu.readline()
                print('%s'%self.RTSFFa)

                contenu= open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_RTSpatialeFacileForte.txt".format(nom,nom), "r")
                ...
                f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_Hetero.xls".format(nom,nom), "a")
                f.write("\nHETERO GENEREE\n\n")
...
class auto(tkinter.Tk):
        def __init__(self,parent):
                ...
                f = open("C:\\Users\\ECOCAPTURE\Desktop\ECOCAPTURE\ICM_APATHY_TASKS\Sujets\{0}\{1}_Auto.xls".format(nom,nom), "a")
                f.write("\nAUTO GENEREEn\n")
                print('AUTO GENEREE')
        ...
        def reactionacote(self):
                ...
                #RT + temps ecoule
                f.write('[{}[{}\n'.format(self.RTacote, self.SRTacote))
