...
class VDf(tkinter.Tk):
	def __init__(self,parent):
		...
		#f = open("C:\\Users\\ECOCAPTURE\Desktop\SujetEntrainement_VerbaleDifficileFaible.xls", "a")
...
class VDF(tkinter.Tk):
	def __init__(self,parent):
		...
		#f = open("C:\\Users\\ECOCAPTURE\Desktop\SujetEntrainement_VerbaleDifficileFort.xls", "a")
...
class VFf(tkinter.Tk):
        def __init__(self,parent):
                ...
                #f = open("C:\\Users\\ECOCAPTURE\Desktop\SujetEntrainement_VerbaleFacileFaible.xls", "a")
        ...
        def debutchrono(self):
                #f = open("C:\\Users\\ECOCAPTURE\Desktop\SujetEntrainement_VerbaleFacileFort.xls", "a")
                print('\nPlus que 30 sec\n')
                #f.write('\n30 sec\n')
                self.startchrono()
